...
CREATE TABLE payment_methods (payment_method_id tinyint(4) NOT NULL AUTO_INCREMENT,name varchar(50) NOT NULL, PRIMARY KEY (payment_method_id));
...
CREATE TABLE clients (client_id int(11) NOT NULL, name varchar(50) NOT NULL, address varchar(50) NOT NULL, city varchar(50) NOT NULL, state char(2) NOT NULL, phone varchar(50) DEFAULT NULL, PRIMARY KEY (client_id));
...
CREATE TABLE products (product_id int(11) NOT NULL AUTO_INCREMENT, name varchar(50) NOT NULL, quantity_in_stock int(11) NOT NULL, unit_price decimal(4,2) NOT NULL, PRIMARY KEY (product_id));
...
CREATE TABLE shippers (shipper_id smallint(6) NOT NULL AUTO_INCREMENT, name varchar(50) NOT NULL, PRIMARY KEY (shipper_id));
...
CREATE TABLE customers (customer_id int(11) NOT NULL AUTO_INCREMENT, first_name varchar(50) NOT NULL, last_name varchar(50) NOT NULL, birth_date date DEFAULT NULL, phone varchar(50) DEFAULT NULL, address varchar(50) NOT NULL, city varchar(50) NOT NULL, state char(2) NOT NULL, points int(11) NOT NULL DEFAULT '0', PRIMARY KEY (customer_id));
...
CREATE TABLE order_item_notes (note_id INT NOT NULL, order_Id INT NOT NULL, product_id INT NOT NULL, note VARCHAR(255) NOT NULL, PRIMARY KEY (note_id));
...
CREATE TABLE offices (office_id int(11) NOT NULL, address varchar(50) NOT NULL, city varchar(50) NOT NULL, state varchar(50) NOT NULL, PRIMARY KEY (office_id));
