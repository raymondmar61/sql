...
select *
from employees
where salary beween 8000 and 12000 #RM:  between is inclusive
and (commission is not null or department_id not in (40, 120, 70))
and hire_date <'1987-06-05';  #RM:  yyyy-mm-dd
...
select first_name || ' ' || last_name as "Full Name", salary
from employees
where commission = 0.00 #RM:  database no commission denoted 0.00
...
select first_name || ' ' || last_name as "Full Name", salary
from employees
where salary not between 7000 and 15000 #RM:  no "is" for between.  Yes "is" for null.
order by "Full Name";
...
select first_name || ' ' || last_name as "Full Name", job_id, hire_date
from employees
where hire_date between '2007-11-05' and '2009-07-05'; #RM:  yyyy-mm-dd
...
select first_name || ' ' || last_name as "Full Name", department_id
from employees
...
select first_name || ' ' || last_name as "Full Name", salary, manager_id
from employees
where manager_id is not null; #RM:  database no manager_id denoted as 0.  I substitute 0 as null.
